...
var ParallaxLayer = React.memo(
  React.forwardRef(
    ({ horizontal, factor = 1, offset = 0, speed = 0, sticky, ...rest }, ref) => {
      ...
      const layerRef = (0, import_react.useRef)(void 0);
...
var Parallax = React.memo(
  React.forwardRef((props, ref) => {
    ...
    const containerRef = (0, import_react.useRef)(void 0);
    const contentRef = (0, import_react.useRef)(void 0);
